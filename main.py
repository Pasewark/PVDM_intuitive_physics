...
parser.add_argument('--devicenum',default='0')
...
def main():
    ...
    args.n_gpus=1
    args.device=torch.device(f'cuda:{args.devicenum}')
    ...
    if args.exp == 'ddpm':
        ...
        if args.n_gpus == 1:
            diffusion(rank=int(args.devicenum), args=args)
        else:
